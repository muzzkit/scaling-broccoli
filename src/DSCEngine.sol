...
contract DSCEngine is ReentrancyGuard {
    ...
    function burnDsc(uint256 amount) public moreThanZero(amount) {
        ...
        _revertIfHealthFactorBroken(msg.sender); // I don't think this would ever hit...
    }
    ...
    // $75 backing $150 DSC
    // Liquidator take $75 backing and burns off the $50
    ...
    function _healthFactor(address user) private view returns (uint256) {
        ...
        // (collateralAdjustedForThreshold i.e. the minimum safe collateral value) × (1e18 for fixed point) ÷ (totalDscMinted i.e. your debt)
